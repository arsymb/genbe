...
export default class PersonRoute extends Component {
    constructor(props) {
        super(props);
    ...
    initialState = {
        idPerson: '', nik: '', name: '', address: '', hp: '', tgl: '', tempatLahir: '', status: '', message: ''
    }

    componentDidMount() {
        if (this.props.match.params.idPerson) {
            this.findBiodataByIdPerson();
        }
    }

    findBiodataByIdPerson = () => {
        // console.log(this.props);
        console.log(this.props.match.params.idPerson);
        axios.get("http://localhost:8080/person/" + this.props.match.params.idPerson)
            .then(response => {
        ...
        return (
            <div>
                <Card className="card-light">
                    ...
                    <Form id="formBiodata" onSubmit={this.state.idPerson ? this.updateBiodata : this.submitBiodata}>
                        <Card.Body>
                            <Row>
                                <Col>
                            ...
                            <Row style={{ textAlign: "center" }}>
                                <Col>
                                    <Button className="btn-save" size="lg" type="submit"><IoIosSave />{this.state.idPerson ? " Update" : " Simpan"}</Button>{' '}
                                </Col>
                                <Col>
